...
angular.module('jrCheckbox', []).directive('jrCheckbox', [function() {
  return {
    restrict: 'A',
    scope: {
      opts: '=jrCheckbox'
    ...
    controller: ['$scope', '$element', function($scope, $element) {
      ...
      // Check dependancies
      if (!window.jQuery) throw 'ERROR: jr-checkbox requires jQuery.';
      
      if (!$scope.opts.hasOwnProperty('checked') || !$scope.opts.hasOwnProperty('unchecked')) throw 'ERROR: jr-checkbox is missing either "checked" or "unchecked" property.';
