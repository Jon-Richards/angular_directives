...
//
//  USAGE:
//  <jr-gapfiller stopAt="footer"></jr-gapfiller>
//
//  NOTE:
//  Since <jr-gapfiller> is an element, it is affected by CSS (inline or external).
//  The <jr-gapfiller> element should remain a block level element to work properly.
//
//  OPTIONS:
...
angular.module('jrGapfiller', []).directive('jrGapfiller', [function(){
  return {
    restrict: 'E',
    controller: ['$scope', '$element', '$attrs', '$document', function($scope, $element, $attrs, $document){
      
      // Check dependancies
      if (!window.jQuery) throw 'ERROR: jr-gapfiller requires jQuery';
